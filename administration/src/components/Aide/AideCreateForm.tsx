...
const AideCreateForm = (save, record) => {
  ...
  const [FUNDER_CHOICE, setFunderChoice] = useState<any[]>([]);
  ...
  useEffect(() => {
    setFunderChoice(funders && funders.map((elt) => {
          ...
          <Box display="flex">
            <Box flex="1" mt={-1}>
              <Box maxWidth={700}>
                ...
                <TextInput
                  source="minAmount"
                  label="Montant minimun de l'aide"
                  validate={[required()]}
                  fullWidth
                />
                <AutocompleteArrayInput
                ...
                <TextInput
                  ...
                  fullWidth
                />
                <TextInput source="contact" label="Contact" fullWidth />
                <TextInput
