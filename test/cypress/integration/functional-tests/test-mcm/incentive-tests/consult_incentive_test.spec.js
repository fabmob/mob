  ...
  it("test how to implement target blank", function () {
    ...
    if (
      ...
      cy.get("#aide-page-0")
        ...
        .then((href) => {
          cy.visit("https://" + Cypress.env("WEBSITE_FQDN") + href);
        });
    ...
    if (
      ...
      if (cy.url().should("match", /moncomptemobilite.fr/)) {
        ...
        cy.url().then(($url) => {
          ...
          cy.visit(
            "https://website-1969.preview.moncomptemobilite.fr/mon-profil/#"
          );
        });
      } else {
        // do something else
