...
describe("Collectivity homepage", function () {
	it("Test of the collectivity homepage", function () {
        ...
        cy.get('#collectivite-contact > .button').should('have.text', 'Nous contacter'); // Button text
		...
		cy.get('.mcm-section-with-support--mac__body > .mb-m').should('have.text', 'MOB est un outil intégré qui vous accompagne dans chaque étape de votre processus.'); // Title
		...
		cy.get(':nth-child(3) > a > .mcm-image').should('have.attr', 'src', '/static/66e7dd5e7118c2530d603c629276e063/logo-fabmob.svg'); // Image 3/7
