...
describe("Citizen homepage", function () {
	it("Test of the citizen homepage", function () {
        ...
        /* ==== Video Section ==== */
        cy.get('.display__item').should('have.text', 'Lire la vidéo'); // Button text TODO video plays onClick
        cy.viewport(365, 568); // Switch to mobile mode for responsive
        cy.get('.display__item').should('have.text', 'Lire la vidéo'); // Button text TODO mobile : video plays onClick & adapts to screen width
