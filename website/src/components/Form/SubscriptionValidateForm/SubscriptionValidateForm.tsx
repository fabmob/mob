...
const SubscriptionValidateForm: FC<any> = ({ children, onSubmit, onChange }) => {
    ...
    >
      ...
      {selectedPayment === PAYMENT_VALUE.SINGLE && (
        <TextField
          ...
          type="number"
          name="amountSingle"
          placeholder={Strings['subscriptions.validate.amountSingle.placeholder']}
          errors={errors}
        />
      )}
      <Checkbox
      ...
      {selectedPayment === PAYMENT_VALUE.MULTIPLE && (
        <>
          ...
          <TextField
            ...
            type="number"
            name="amountMultiple"
            placeholder={Strings['subscriptions.validate.amountMultiple.placeholder']}
            errors={errors}
          />
          <TextField
            {...register('lastPayment')}
            ...
            type="text"
            errors={errors}
            placeholder={Strings['subscriptions.validate.lastPayment.placeholder']}
          />
        </>
      )}
      <Checkbox
