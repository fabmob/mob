...
const RequestReject: FC<RequestRejectProps> = ({
  ...
  const onSubmit = (subscriptionRejection: SubscriptionRejection) => {
    subscriptionRejection.comments || delete(subscriptionRejection.comments)
    setRejectionMotif(subscriptionRejection);
    setShowModal(true);
  };
  /**
  ...
  const onRejectSubscription = (
    ...
    putSubscriptionReject(subscriptionId, subscriptionRejection)
      .then(() => {
        setShowModal(false);
