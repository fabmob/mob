...
const AdministrerDemandes: FC<PageProps> = ({
  ...
  const renderExplicitSubscriptions = (): string => {
  ...
  return (
    <Layout
      ...
      fullWidth
      pageTitle={Strings['dashboard.subscription.title.manage']}
    >
                ...
                <div className="dashboard-group-first">
                  ...
                  <div className="dashboard-group-second">
                    ...
                    <div className="bloc-sections">
                      <SearchResultsTitle
                        defaultInitText={renderExplicitSubscriptions()}
                      ...
                      <div className="mcm-filters__dropdown">
                        <FilterSelect
                          ...
                          placeholder={
                            Strings['filter.select.placeholder.community']
                          }
                        />
                      </div>
                      <div className="mcm-filters__dropdown">
                        <FilterSelect
                          ...
                          placeholder={
                            Strings['filter.select.placeholder.name']
                          }
                        />
                      </div>
                    </div>
