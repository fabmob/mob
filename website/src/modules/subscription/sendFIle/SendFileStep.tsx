  ...
  return (
    <div className="mb-m">
      <div>
        ...
        {formattedAttachement.length >= 2 ? (
          <div className="mcm-demande__fields-section">
            <Heading level="h3" color="blue">
              {Strings['subscription.second.step.send.multi.justif']}
            </Heading>
          </div>
        ) : (
          <div className="mcm-demande__fields-section">
        ...
        {!!attachmentMetadata?.length && (
          <div className="app_justif">
            {attachmentMetadata.length >= 2 ? (
            <Heading level="h3" color="blue" className="mb-s">
              {Strings['subscription.justif.mobile.justif.title']}
            </Heading>
            ) : (
              <Heading level="h3" color="blue" className="mb-s">
              {Strings['subscription.justif.mobile.justif.one.title']}
            </Heading>
            )}
            <div>
              {attachmentMetadata.length >= 2 ? (
                <Heading level="p" className="justif_title">
                  {Strings['subscription.justif.buy.justifs.multiples']}
                </Heading>
              ) : (
                <Heading level="p" className="justif_title">
