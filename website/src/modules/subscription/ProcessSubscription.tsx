          ...
          result = {
            ...
            [element.name]: yup
              ...
              .test(
                ...
                Strings['citizens.error.date.format'],
    ...
    if (step === 0) {
      ...
      incentiveSpecificFields.forEach((element: object) => {
        if (element.inputFormat === 'listeChoix') {
          ...
          const [day, month, year] = formData[element.name].split('/');
          ...
          formatData = {
            ...formatData,
            [element.title]: format(dateValue, 'yyyy-MM-dd'),
          };
        } else if (element.inputFormat === 'Numerique') {
          formatData = {
            ...formatData,
          ...
          <div className="mcm-subscription">
            ...
            <div className="mcm-subscription__sidebar">
              {citizen && step !== 1 && (
                <>
                  <CitizenCard
                    identity={{ ...citizen, isCitizenDeleted: false }}
                    showSummary={false}
                  />
