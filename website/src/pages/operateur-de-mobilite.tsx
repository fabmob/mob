...
const navLinks = [
  { label: Strings['operateur.mobility.nav.links.label.citizen'], path: '/', active: false },
  { label: Strings['operateur.mobility.nav.links.label.employer'], path: '/employeur', active: false },
  { label: Strings['operateur.mobility.nav.links.label.collectivite'], path: '/collectivite', active: false },
  {
        ...
        <section className="mcm-home__header">
          <div className="page-container o-blue-bg-wrapper">
            <h1 className="mt-m mb-m">
              {Strings['operateur.mobility.title']}
            </h1>
        ...
        <main className="mcm-container__main">
          ...
          >
            ...
            <OrderedList
              items={[
                <>
                  <span className="special">{Strings['operateur.mobility.description.item1']}</span>
                  {Strings['operateur.mobility.description.item1.text']}
                </>,
                <>
                  <span className="special">{Strings['operateur.mobility.description.item2']}</span>
                  {Strings['operateur.mobility.description.item2.text']}
                </>,
                <>
                  <span className="special">{Strings['operateur.mobility.description.item3']}</span>
          ...
          <SectionWithImage
            ...
            className="section--over-width"
          >
            <h2 className="mb-s">{Strings['operateur.mobility.why.mob.title']}</h2>
            <p className="mb-xs">
            ...
            <Link id="op-contact2" to="/contact">
              <Button>{Strings['operateur.mobility.why.mob.button.contact.us']}</Button>
            </Link>
            <Link id="op-decouvrir" to="/decouvrir-le-projet">
              <Button secondary>{Strings['operateur.mobility.why.mob.button.discover.project']}</Button>
            </Link>
          </SectionWithImage>
          <h2 className="mb-m mt-m">{Strings['operateur.mobility.why.mob.all.partners']}</h2>
