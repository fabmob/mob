...
const navLinks = [
  { label: Strings['employeur.nav.links.label.citizen'], path: '/', active: false },
  { label: Strings['employeur.nav.links.label.employer'], path: '/employeur', active: true },
  { label: Strings['employeur.nav.links.label.collectivite'], path: '/collectivite', active: false },
  {
...
const stepList: StepsItemProps[] = [
  ...
  {
    image: graph,
    text: Strings['employeur.steps.text.profile'],
  },
];
        ...
        <section className="mcm-home__header">
          <div className="page-container m-bg-wrapper">
            ...
            {Strings['employeur.title.part1']}{' '}
              <span className="special">{Strings['employeur.title.part2']}</span>{' '}
        ...
        <main className="mcm-container__main">
          ...
          <div className="mcm-section-with-support--iphone">
            ...
            <div className="mcm-section-with-support--iphone__body">
              <h2 className="mb-m">
              {Strings['employeur.description.title']}
              </h2>
              <OrderedList
                items={[
                  <>
                    <span className="special">{Strings['employeur.description.item1']}</span>
                    {Strings['employeur.description.item1.text']}
                  </>,
                  <>
                    <span className="special">{Strings['employeur.description.item2']}</span>
                    {Strings['employeur.description.item2.text']}
                  </>,
                  <>
                    <span className="special">{Strings['employeur.description.item3']}</span>
          ...
          >
            <h2 className="mb-s">{Strings['employeur.why.mob.title']}</h2>
            <p className="mb-xs">
            {Strings['employeur.why.mob.item1']}
            </p>
            <p className="mb-s">
            {Strings['employeur.why.mob.item2']}
            </p>
            ...
            <Link id="employeur-decouvrir" to="/decouvrir-le-projet">
              <Button secondary>{Strings['employeur.why.mob.button.discover.project']}</Button>
            </Link>
          </SectionWithImage>
          <h2 className="mb-m mt-m">{Strings['employeur.why.mob.all.partners']}</h2>
