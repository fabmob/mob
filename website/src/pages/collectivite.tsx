...
const navLinks = [
  { label: Strings['collectivite.nav.links.label.citizen'], path: '/', active: false },
  { label: Strings['collectivite.nav.links.label.employer'], path: '/employeur', active: false },
  { label: Strings['collectivite.nav.links.label.collectivite'], path: '/collectivite', active: true },
  {
    ...
    >
      <div className="mcm-home mcm-home--collectivite">
        ...
        <main className="mcm-container__main">
          ...
          <div className="mcm-section-with-support--mac">
            ...
            <div className="mcm-section-with-support--mac__body">
              ...
              <OrderedList
                items={[
                  <>
                    <span className="special">{Strings['collectivite.description.item1']}</span>
                    {Strings['collectivite.description.item1.text']}
                  </>,
                  <>
                    <span className="special">{Strings['collectivite.description.item2']}</span>
                    {Strings['collectivite.description.item2.text']}
                  </>,
                  <>
                    <span className="special">{Strings['collectivite.description.item3']}</span>
          ...
          >
            <h2 className="mb-s">{Strings['collectivite.why.mob.title']}</h2>
            <p className="mb-xs">
              {Strings['collectivite.why.mob.item1']}
            </p>
            <p className="mb-s">
              {Strings['collectivite.why.mob.item2']}
            </p>
            <Link id="collectivite-contact2" to="/contact">
              <Button>{Strings['collectivite.why.mob.button.contact.us']}</Button>
            </Link>
            <Link id="collectivite-decouvrir" to="/decouvrir-le-projet">
              <Button secondary>{Strings['collectivite.why.mob.button.discover.project']}</Button>
            </Link>
          </SectionWithImage>
          <h2 className="mb-m mt-m">{Strings['collectivite.why.mob.all.partners']}</h2>
