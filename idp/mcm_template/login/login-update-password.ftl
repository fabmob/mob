...
<@layout.registrationLayout displayInfo=true; section>
    ...
    <#elseif section = "form">
        <form id="kc-passwd-update-form" class="${properties.kcFormClass!}" action="${url.loginAction}" method="post">
            <div>
                <p>${msg("passwordPolicyText")}</p>
                <ul>
                    <li>${msg("passwordPolicy1")}</li>
                    <li>${msg("passwordPolicy2")}</li>
                    <li>${msg("passwordPolicy3")}</li>
                    <li>${msg("passwordPolicy4")}</li>
                    <li>${msg("passwordPolicy5")}</li>
                </ul>
            </div>
