        ...
        <nav role="navigation" aria-label="Menu principal">
            ...
            <div class="mcm-nav">
                <ul class="mcm-nav-list">
                    <li class="nav-item">
                        <a href="https://${properties.websiteFQDN!}/recherche/" alt="Rechercher une aide">
                            Rechercher une aide
                        </a>
                    </li>
                    <li class="nav-item nav-login">
                        <a href="${properties.redirectToLoginPage}" alt="Se connecter">
                            Se connecter
                        </a>
                    </li>
                </ul>
                <ul class="mcm-mobile-nav">
                    ...
                    <li class="nav-item">
                        <a href="https://${properties.websiteFQDN!}/foire-aux-questions" alt="La foire aux questions">
                            Foire aux questions
                        </a>
                    </li>
                    <li class="nav-item">
